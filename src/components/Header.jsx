...
const Header = () => {
  const toggleMenuMobile = () => {
    ...
    menuMb.classList.toggle("max-lg:hidden")
  }
  return (
    <header className="bg-white w-full">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <img className="h-8 w-auto" src="/logo/mark.svg" alt="logo" />
          </a>
        </div>
        <div className="flex lg:hidden">
          <button onClick={toggleMenuMobile} type="button" className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          ...
          <a className="text-sm/6 font-semibold text-gray-900">Features</a>
      ...
      <div className="menu-mb lg:hidden" role="dialog" aria-modal="true">
        ...
        <div className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            ...
            <button onClick={toggleMenuMobile} type="button" className="-m-2.5 rounded-md p-2.5 text-gray-700">
